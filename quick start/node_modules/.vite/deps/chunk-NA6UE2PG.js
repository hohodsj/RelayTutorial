        ...
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
          ...
          if (eventShouldThrow(_fieldError)) {
            switch (_fieldError.kind) {
              ...
              default:
                _fieldError.kind;
                true ? true ? invariant(false, "Relay: Unexpected event kind: %s", _fieldError.kind) : invariant(false) : void 0;
            }
          }
        }
      } catch (err) {
...
var require_ResolverFragments = __commonJS({
  "node_modules/relay-runtime/lib/store/ResolverFragments.js"(exports, module) {
    ...
    var _require2 = require_handlePotentialSnapshotErrors();
    var eventShouldThrow = _require2.eventShouldThrow;
...
// node_modules/relay-runtime/lib/store/live-resolvers/resolverDataInjector.js
var require_resolverDataInjector = __commonJS({
  "node_modules/relay-runtime/lib/store/live-resolvers/resolverDataInjector.js"(exports, module) {
    "use strict";
...
// node_modules/relay-runtime/lib/store/observeFragmentExperimental.js
var require_observeFragmentExperimental = __commonJS({
  "node_modules/relay-runtime/lib/store/observeFragmentExperimental.js"(exports, module) {
    "use strict";
    var _interopRequireDefault = require_interopRequireDefault()["default"];
    ...
    var getObservableForActiveRequest = _require.getObservableForActiveRequest;
    var _require2 = require_GraphQLTag();
    var getFragment = _require2.getFragment;
    var _require3 = require_handlePotentialSnapshotErrors();
    ...
    function observeFragment(environment, fragment, fragmentRef) {
      ...
      !(((_fragmentNode$metadat = fragmentNode.metadata) === null || _fragmentNode$metadat === void 0 ? void 0 : _fragmentNode$metadat.hasClientEdges) == null) ? true ? invariant(false, "Client edges aren't supported yet.") : invariant(false) : void 0;
      !(fragmentSelector != null) ? true ? invariant(false, "Expected a selector, got null.") : invariant(false) : void 0;
      ...
      true ? true ? invariant(false, "Unsupported fragment selector kind") : invariant(false) : void 0;
    }
    ...
    function snapshotToFragmentState(environment, fragmentNode, owner, snapshot) {
      ...
      !(snapshot.data != null) ? true ? invariant(false, "Expected data to be non-null.") : invariant(false) : void 0;
      return {
        state: "ok",
        value: snapshot.data
      };
...
// node_modules/relay-runtime/lib/store/observeQueryExperimental.js
var require_observeQueryExperimental = __commonJS({
  "node_modules/relay-runtime/lib/store/observeQueryExperimental.js"(exports, module) {
    "use strict";
    var _interopRequireDefault = require_interopRequireDefault()["default"];
    var _defineProperty2 = _interopRequireDefault(require_defineProperty());
    var _require = require_observeFragmentExperimental();
    var observeFragment = _require.observeFragment;
...
// node_modules/relay-runtime/lib/store/waitForFragmentExperimental.js
var require_waitForFragmentExperimental = __commonJS({
  "node_modules/relay-runtime/lib/store/waitForFragmentExperimental.js"(exports, module) {
    "use strict";
    var _asyncToGenerator = require_asyncToGenerator().default;
    var _require = require_observeFragmentExperimental();
    var observeFragment = _require.observeFragment;
...
var require_experimental = __commonJS({
  "node_modules/relay-runtime/lib/experimental.js"(exports, module) {
    ...
    var _require = require_observeFragmentExperimental();
    var observeFragment = _require.observeFragment;
    var _require2 = require_observeQueryExperimental();
    var observeQuery = _require2.observeQuery;
    var _require3 = require_waitForFragmentExperimental();
    var waitForFragmentData = _require3.waitForFragmentData;
...
var require_ConnectionHandler = __commonJS({
  "node_modules/relay-runtime/lib/handlers/connection/ConnectionHandler.js"(exports, module) {
    ...
    function update(store, payload) {
      ...
      if (!serverConnection) {
        record.setValue(null, payload.handleKey, void 0, record.getErrors(payload.fieldKey));
        return;
      }
...
var require_fetchQuery = __commonJS({
  "node_modules/relay-runtime/lib/query/fetchQuery.js"(exports, module) {
    ...
    var _require3 = require_GraphQLTag();
...
var require_RelayModernFragmentSpecResolver = __commonJS({
  "node_modules/relay-runtime/lib/store/RelayModernFragmentSpecResolver.js"(exports, module) {
    ...
    var _require = require_handlePotentialSnapshotErrors();
    var handlePotentialSnapshotErrors = _require.handlePotentialSnapshotErrors;
...
// node_modules/relay-runtime/lib/store/createRelayLoggingContext.js
var require_createRelayLoggingContext = __commonJS({
  "node_modules/relay-runtime/lib/store/createRelayLoggingContext.js"(exports, module) {
    "use strict";
    var invariant = require_browser();
    ...
    function createRelayLoggingContext(react) {
      ...
      !(react === firstReact) ? true ? invariant(false, "[createRelayLoggingContext]: You are passing a different instance of React", react.version) : invariant(false) : void 0;
...
// node_modules/relay-runtime/lib/store/live-resolvers/LiveResolverSuspenseSentinel.js
var require_LiveResolverSuspenseSentinel = __commonJS({
  "node_modules/relay-runtime/lib/store/live-resolvers/LiveResolverSuspenseSentinel.js"(exports, module) {
    "use strict";
    ...
    var RelayResponseNormalizer = function() {
      ...
      _proto._validateRecordType = function _validateRecordType(record, field, payload) {
        ...
        if (true) {
          ...
          true ? warning(_expected, "RelayResponseNormalizer: Invalid record `%s`. Expected %s to be consistent, but the record was assigned conflicting types `%s` and `%s`. The GraphQL server likely violated the globally unique id requirement by returning the same id for different objects.", _dataID, TYPENAME_KEY, RelayModernRecord.getType(record), _typeName3) : void 0;
        }
      };
      _proto._validateConflictingFieldsWithIdenticalId = function _validateConflictingFieldsWithIdenticalId(record, storageKey, fieldValue) {
        if (true) {
          ...
          var dataID = RelayModernRecord.getDataID(record);
          var expected = storageKey === TYPENAME_KEY || previousValue === void 0 || areEqual(previousValue, fieldValue);
          true ? warning(expected, "RelayResponseNormalizer: Invalid record. The record contains two instances of the same id: `%s` with conflicting field, %s and its values: %s and %s. If two fields are different but share the same id, one field will overwrite the other.", dataID, storageKey, previousValue, fieldValue) : void 0;
        }
      };
      _proto._validateConflictingLinkedFieldsWithIdenticalId = function _validateConflictingLinkedFieldsWithIdenticalId(prevID, nextID, storageKey) {
        if (true) {
          var expected = prevID === void 0 || prevID === nextID;
          true ? warning(expected, "RelayResponseNormalizer: Invalid record. The record contains references to the conflicting field, %s and its id values: %s and %s. We need to make sure that the record the field points to remains consistent or one field will overwrite the other.", storageKey, prevID, nextID) : void 0;
        }
      };
...
var require_RelayRecordSourceProxy = __commonJS({
  "node_modules/relay-runtime/lib/mutations/RelayRecordSourceProxy.js"(exports, module) {
    ...
    var RelayRecordSourceProxy = function() {
      function RelayRecordSourceProxy2(mutator, getDataID, handlerProvider, missingFieldHandlers, log) {
...
var require_DataChecker = __commonJS({
  "node_modules/relay-runtime/lib/store/DataChecker.js"(exports, module) {
    ...
    var DataChecker = function() {
      function DataChecker2(getSourceForActor, getTargetForActor, defaultActorIdentifier, variables, handlers, operationLoader, getDataID, shouldProcessClientComponents, log) {
      ...
      _proto._getMutatorAndRecordProxyForActor = function _getMutatorAndRecordProxyForActor(actorIdentifier) {
        ...
        if (tuple == null) {
          ...
          var recordSourceProxy = new RelayRecordSourceProxy(mutator, this._getDataID, void 0, this._handlers, this._log);
...
// node_modules/relay-runtime/lib/store/live-resolvers/getOutputTypeRecordIDs.js
var require_getOutputTypeRecordIDs = __commonJS({
  "node_modules/relay-runtime/lib/store/live-resolvers/getOutputTypeRecordIDs.js"(exports, module) {
    "use strict";
    var RelayModernRecord = require_RelayModernRecord();
    var _require = require_RelayStoreUtils();
...
// node_modules/relay-runtime/lib/store/live-resolvers/isLiveStateValue.js
var require_isLiveStateValue = __commonJS({
  "node_modules/relay-runtime/lib/store/live-resolvers/isLiveStateValue.js"(exports, module) {
    "use strict";
...
// node_modules/relay-runtime/lib/store/live-resolvers/LiveResolverCache.js
var require_LiveResolverCache = __commonJS({
  "node_modules/relay-runtime/lib/store/live-resolvers/LiveResolverCache.js"(exports, module) {
    "use strict";
    var _interopRequireDefault = require_interopRequireDefault()["default"];
    var _createForOfIteratorHelper2 = _interopRequireDefault(require_createForOfIteratorHelper());
    var recycleNodesInto = require_recycleNodesInto();
    ...
    var _require2 = require_ClientID();
    var generateClientID = _require2.generateClientID;
    var generateClientObjectClientID = _require2.generateClientObjectClientID;
    var RelayModernRecord = require_RelayModernRecord();
    var _require3 = require_RelayModernSelector();
    var createNormalizationSelector = _require3.createNormalizationSelector;
    var RelayRecordSource = require_RelayRecordSource();
    var _require4 = require_RelayResponseNormalizer();
    var normalize = _require4.normalize;
    var _require5 = require_RelayStoreUtils();
    var RELAY_RESOLVER_ERROR_KEY = _require5.RELAY_RESOLVER_ERROR_KEY;
    var RELAY_RESOLVER_INVALIDATION_KEY = _require5.RELAY_RESOLVER_INVALIDATION_KEY;
    var RELAY_RESOLVER_OUTPUT_TYPE_RECORD_IDS = _require5.RELAY_RESOLVER_OUTPUT_TYPE_RECORD_IDS;
    var RELAY_RESOLVER_SNAPSHOT_KEY = _require5.RELAY_RESOLVER_SNAPSHOT_KEY;
    var RELAY_RESOLVER_VALUE_KEY = _require5.RELAY_RESOLVER_VALUE_KEY;
    var getReadTimeResolverStorageKey = _require5.getReadTimeResolverStorageKey;
    var getStorageKey = _require5.getStorageKey;
    var getOutputTypeRecordIDs = require_getOutputTypeRecordIDs();
    var isLiveStateValue = require_isLiveStateValue();
    var _require6 = require_LiveResolverSuspenseSentinel();
    var isSuspenseSentinel = _require6.isSuspenseSentinel;
    var invariant = require_browser();
    var warning = require_warning();
    ...
    var LiveResolverCache = function() {
      function LiveResolverCache2(getRecordSource, store) {
      ...
      var _proto = LiveResolverCache2.prototype;
        ...
        if (linkedRecord == null || this._isInvalid(linkedRecord, getDataForResolverFragment)) {
          ...
          if (field.kind === RELAY_LIVE_RESOLVER) {
            if (evaluationResult.resolverResult != null) {
              if (true) {
                !isLiveStateValue(evaluationResult.resolverResult) ? true ? invariant(false, 'Expected the @live Relay Resolver backing the field "%s" to return a value that implements LiveState. Did you mean to remove the @live annotation on this resolver?', field.path) : invariant(false) : void 0;
              }
              !(evaluationResult.error == null) ? true ? invariant(false, "Did not expect resolver to have both a value and an error.") : invariant(false) : void 0;
          ...
          if (!isLiveStateValue(_liveState)) {
            true ? true ? invariant(false, "Unexpected LiveState value returned from Relay Resolver internal field `RELAY_RESOLVER_LIVE_STATE_VALUE`. It is likely a bug in Relay, or a corrupt state of the relay store state Field Path `%s`. Record `%s`.", field.path, JSON.stringify(linkedRecord)) : invariant(false) : void 0;
          }
      ...
      _proto.getLiveResolverPromise = function getLiveResolverPromise(liveStateID) {
        ...
        !(liveStateRecord != null) ? true ? invariant(false, "Expected to find record for live resolver.") : invariant(false) : void 0;
      ...
      _proto.batchLiveStateUpdates = function batchLiveStateUpdates(callback) {
        !!this._handlingBatch ? true ? invariant(false, "Unexpected nested call to batchLiveStateUpdates.") : invariant(false) : void 0;
      ...
      _proto._setResolverValue = function _setResolverValue(resolverRecord, value, field, variables) {
        ...
        if (value != null && normalizationInfo != null && !isSuspenseSentinel(value)) {
          ...
          var nextOutputTypeRecordIDs = /* @__PURE__ */ new Set();
          var currentSource = this._getRecordSource();
          if (normalizationInfo.plural) {
            !Array.isArray(value) ? true ? invariant(false, "_setResolverValue: Expected array value for plural @outputType resolver.") : invariant(false) : void 0;
            resolverValue = [];
            var nextSource = RelayRecordSource.create();
            for (var ii = 0; ii < value.length; ii++) {
              ...
              !(typeof currentValue === "object") ? true ? invariant(false, "_setResolverValue: Expected object value as the payload for the @outputType resolver.") : invariant(false) : void 0;
            ...
            !(typeof value === "object") ? true ? invariant(false, "_setResolverValue: Expected object value as the payload for the @outputType resolver.") : invariant(false) : void 0;
      ...
      _proto._normalizeOutputTypeValue = function _normalizeOutputTypeValue(outputTypeDataID, value, variables, normalizationInfo, fieldPath, typename) {
        ...
        switch (normalizationInfo.kind) {
          ...
          default:
            ...
            true ? true ? invariant(false, "LiveResolverCache: Unexpected normalization info kind `%s`.", normalizationInfo.kind) : invariant(false) : void 0;
        }
      };
    ...
    function getAllLinkedRecordIds(record) {
      var linkedRecordIDs = /* @__PURE__ */ new Set();
      RelayModernRecord.getFields(record).forEach(function(field) {
        if (RelayModernRecord.hasLinkedRecordID(record, field)) {
          ...
          (_RelayModernRecord$ge = RelayModernRecord.getLinkedRecordIDs(record, field)) === null || _RelayModernRecord$ge === void 0 ? void 0 : _RelayModernRecord$ge.forEach(function(linkedRecordID2) {
            if (linkedRecordID2 != null) {
              linkedRecordIDs.add(linkedRecordID2);
            }
          });
        }
      });
    ...
    function expectRecord(source, recordID) {
      ...
      !(record != null) ? true ? invariant(false, "Expected a record with ID `%s` to exist in the record source.", recordID) : invariant(false) : void 0;
      return record;
    }
    ...
    function getConcreteTypename(normalizationInfo, currentValue) {
      ...
      !(typename != null) ? true ? invariant(false, "normalizationInfo.concreteType should not be null, or the value returned from the resolver should include a __typename field, or the resolver should have a flow error. If not, this indicates a bug in Relay.") : invariant(false) : void 0;
      return typename;
    }
    module.exports = {
      LiveResolverCache,
...
var require_RelayReader = __commonJS({
  "node_modules/relay-runtime/lib/store/RelayReader.js"(exports, module) {
    ...
    var RESOLVER_FRAGMENT_ERRORED_SENTINEL = _require4.RESOLVER_FRAGMENT_ERRORED_SENTINEL;
    ...
    var RelayReader = function() {
      ...
      _proto._asResult = function _asResult(value) {
        ...
        var errors = this._fieldErrors.map(function(error) {
          switch (error.kind) {
            ...
            default:
              error.kind;
              true ? true ? invariant(false, "Unexpected error fieldError kind: %s", error.kind) : invariant(false) : void 0;
          }
        }).filter(Boolean);
        return {
          ok: false,
      ...
      _proto._readClientSideDirectiveField = function _readClientSideDirectiveField(selection, record, data) {
        switch (selection.field.kind) {
          ...
          default:
            ...
            true ? true ? invariant(false, "RelayReader(): Unexpected ast kind `%s`.", selection.field.kind) : invariant(false) : void 0;
        }
      };
        ...
        var evaluate = function evaluate2() {
          if (fragment != null) {
            ...
            return withResolverContext(resolverContext, function() {
              var _getResolverValue = getResolverValue(field, _this._variables, key, _this._resolverContext), resolverResult2 = _getResolverValue[0], resolverError2 = _getResolverValue[1];
              return {
      ...
      _proto._readClientEdge = function _readClientEdge(field, record, data) {
        ...
        if (field.linkedField.plural) {
          !Array.isArray(clientEdgeResolverResponse) ? true ? invariant(false, "Expected plural Client Edge Relay Resolver at `%s` in `%s` to return an array containing IDs or objects with shape {id}.", backingField.path, this._owner.identifier) : invariant(false) : void 0;
          var storeIDs;
          !(field.kind === "ClientEdgeToClientObject") ? true ? invariant(false, "Unexpected Client Edge to plural server type `%s`. This should be prevented by the compiler.", field.kind) : invariant(false) : void 0;
          if (field.backingField.normalizationInfo == null) {
            storeIDs = clientEdgeResolverResponse.map(function(itemResponse) {
              ...
              !(typeof concreteType2 === "string") ? true ? invariant(false, "Expected resolver for field at `%s` in `%s` modeling an edge to an abstract type to return an object with a `__typename` property.", backingField.path, _this3._owner.identifier) : invariant(false) : void 0;
              ...
              if (modelResolvers2 != null) {
                ...
                !(modelResolver2 !== void 0) ? true ? invariant(false, "Invalid `__typename` returned by resolver at `%s` in `%s`. Expected one of %s but got `%s`.", backingField.path, _this3._owner.identifier, Object.keys(modelResolvers2).join(", "), concreteType2) : invariant(false) : void 0;
          ...
          if (field.kind === "ClientEdgeToClientObject") {
            if (field.backingField.normalizationInfo == null) {
              !(typeof concreteType === "string") ? true ? invariant(false, "Expected resolver for field at `%s` in `%s` modeling an edge to an abstract type to return an object with a `__typename` property.", backingField.path, this._owner.identifier) : invariant(false) : void 0;
          ...
          if (modelResolvers != null) {
            ...
            !(modelResolver !== void 0) ? true ? invariant(false, "Invalid `__typename` returned by resolver at `%s` in `%s`. Expected one of %s but got `%s`.", backingField.path, this._owner.identifier, Object.keys(modelResolvers).join(", "), concreteType) : invariant(false) : void 0;
          ...
          !(prevData == null || typeof prevData === "object") ? true ? invariant(false, "RelayReader(): Expected data for field at `%s` in `%s` on record `%s` to be an object, got `%s`.", backingField.path, this._owner.identifier, RelayModernRecord.getDataID(record), prevData) : invariant(false) : void 0;
          var prevErrors = this._fieldErrors;
          this._fieldErrors = null;
      ...
      _proto._readLink = function _readLink(field, record, data) {
        ...
        var prevData = data[fieldName];
        !(prevData == null || typeof prevData === "object") ? true ? invariant(false, "RelayReader(): Expected data for field `%s` at `%s` on record `%s` to be an object, got `%s`.", fieldName, this._owner.identifier, RelayModernRecord.getDataID(record), prevData) : invariant(false) : void 0;
        var prevErrors = this._fieldErrors;
        this._fieldErrors = null;
      ...
      _proto._readLinkedIds = function _readLinkedIds(field, linkedIDs, record, data) {
        ...
        linkedIDs.forEach(function(linkedID, nextIndex) {
          ...
          var prevErrors2 = _this4._fieldErrors;
          _this4._fieldErrors = null;
          linkedArray[nextIndex] = _this4._traverse(field, linkedID, prevItem);
          _this4._prependPreviousErrors(prevErrors2, nextIndex);
        });
        this._prependPreviousErrors(prevErrors, fieldName);
      ...
      _proto._readModuleImport = function _readModuleImport(moduleImport, record, data) {
        ...
        var component = relayStoreComponent !== void 0 ? relayStoreComponent : moduleImport.componentModuleProvider;
        if (component == null) {
          if (component === void 0) {
    ...
    function markFieldErrorHasHandled(event) {
      switch (event.kind) {
        ...
        default:
          event.kind;
          true ? true ? invariant(false, "Unexpected error response field kind: %s", event.kind) : invariant(false) : void 0;
      }
    }
    ...
    function extractIdFromResponse(individualResponse, path, owner) {
      ...
      true ? true ? invariant(false, "Expected object returned from edge resolver to be a string or an object with an `id` property at path %s in %s,", path, owner) : invariant(false) : void 0;
    }
    module.exports = {
      read
    };
...
var require_RelayModernStore = __commonJS({
  "node_modules/relay-runtime/lib/store/RelayModernStore.js"(exports, module) {
    ...
    var _require2 = require_LiveResolverCache();
    var LiveResolverCache = _require2.LiveResolverCache;
    var RELAY_RESOLVER_LIVE_STATE_SUBSCRIPTION_KEY = _require2.RELAY_RESOLVER_LIVE_STATE_SUBSCRIPTION_KEY;
    var getUpdatedDataIDs = _require2.getUpdatedDataIDs;
    var RelayModernRecord = require_RelayModernRecord();
    ...
    var RelayModernStore = function() {
      ...
      _proto.restore = function restore() {
        ...
        !optimisticSource ? true ? invariant(false, "RelayModernStore: Unexpected call to restore(), expected a snapshot to exist (make sure to call snapshot()).") : invariant(false) : void 0;
        var log = this.__log;
        if (log != null) {
          log({
            name: "store.restore"
          ...
          try {
            for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
              ...
              if (this._shouldRetainWithinTTL_EXPERIMENTAL) {
                ...
                !(_queryCacheExpirationTime != null) ? true ? invariant(false, "Query cache expiration time should be non-null if executing GC") : invariant(false) : void 0;
...
var require_RelayPublishQueue = __commonJS({
  "node_modules/relay-runtime/lib/store/RelayPublishQueue.js"(exports, module) {
    ...
    var RelayPublishQueue = function() {
      function RelayPublishQueue2(store, handlerProvider, getDataID, missingFieldHandlers, log) {
      ...
      _proto.run = function run(sourceOperation) {
        ...
        RelayFeatureFlags.DISALLOW_NESTED_UPDATES ? !(this._isRunning !== true) ? true ? invariant(false, "A store update was detected within another store update. Please make sure new store updates aren't being executed within an updater function for a different update.") : invariant(false) : void 0 : true ? warning(this._isRunning !== true, "A store update was detected within another store update. Please make sure new store updates aren't being executed within an updater function for a different update.") : void 0;
    ...
    var RelayModernEnvironment = function() {
      ...
      _proto.execute = function execute(_ref) {
        ...
        return this._execute({
          createSource: function createSource() {
            return _this7.getNetwork().execute(operation.request.node.params, operation.request.variables, operation.request.cacheConfig || {}, null, void 0, void 0, void 0, function() {
...
var require_lib = __commonJS({
  "node_modules/relay-runtime/lib/index.js"(exports, module) {
    ...
    var createRelayLoggingContext = require_createRelayLoggingContext();
    var isRelayModernEnvironment = require_isRelayModernEnvironment();
    ...
    var _require4 = require_handlePotentialSnapshotErrors();
    var handlePotentialSnapshotErrors = _require4.handlePotentialSnapshotErrors;
    var isPromise = require_isPromise();
    var isScalarAndEqual = require_isScalarAndEqual();
    var recycleNodesInto = require_recycleNodesInto();
    var RelayConcreteNode = require_RelayConcreteNode();
    ...
    var RelayReplaySubject = require_RelayReplaySubject();
    var _require5 = require_stableCopy();
    var hasCycle = _require5.hasCycle;
    var stableCopy = _require5.stableCopy;
    var withProvidedVariables = require_withProvidedVariables();
    if (true) {
...
fbjs/lib/areEqual.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-NA6UE2PG.js.map
